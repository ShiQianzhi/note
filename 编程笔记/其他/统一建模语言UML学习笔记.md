...
![UML模型](data/images/统一建模语言UML学习笔记-20260715115521-1.png)
...
![类图示例图](data/images/统一建模语言UML学习笔记-20260715115521-2.png)

#### 2.1.2 用例
类图就是编程对象，包括类名、属性、操作三个部分，也可以看作抽象数据类型。  
![类示例图](data/images/统一建模语言UML学习笔记-20260715115521-3.png)  
类名（出现在第一个分区中）
类属性  
属性显示在第二个分区中  
属性类型显示在冒号后  
![属性类型](data/images/统一建模语言UML学习笔记-20260715115521-4.png)
