...
![通信方式](data/images/计算机网络 - OSI-20260715115521-1.png)
...
### 4.1 IP 数据报格式
![IP 数据报格式](data/images/计算机网络 - OSI-20260715115521-2.png)
...
![片偏移示例图](data/images/计算机网络 - OSI-20260715115521-3.png)
...
{< 网络号 >, < 主机号 >}
```
![IP地址分类](data/images/计算机网络 - OSI-20260715115521-4.png)