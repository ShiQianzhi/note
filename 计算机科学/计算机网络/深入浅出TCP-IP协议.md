...
![网络体系结构](data/images/深入浅出TCP-IP协议-20260715115521-1.png)  
...
![数据包分层结构](data/images/深入浅出TCP-IP协议-20260715115521-2.png)  
简单来说数据包由：首部 + 数据组成，首部是每一层数据结构的标识，方便各层独立处理。
![数据包分层传输流程示意图](data/images/深入浅出TCP-IP协议-20260715115521-3.png)
